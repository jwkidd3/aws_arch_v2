...
# Lab 2 Setup Script: AMI Creation & Instance Lifecycle
# AWS Architecting Course - Day 1, Session 2
# Duration: 45 minutes
...
# Main function
main() {
    print_header "AWS Architecting Course - Lab 2 Setup"
    print_status "Setting up AMI Creation & Instance Lifecycle Lab"
    
    # Create lab directory structure
    LAB_DIR="lab2-ami-instance-lifecycle"
...
4. **User Data Script:**
   ```bash
   #!/bin/bash
   # Advanced user data script for lifecycle testing
   yum update -y
   ...
   <head>
       ...
       <style>
           ...
           .command { background: #f8f8f8; padding: 10px; font-family: monospace; border-radius: 3px; }
       </style>
   </head>
   <body>
       <div class="container">
           ...
           <div class="info-box">
               ...
               <ul>
                   ...
                   <li><a href="/instance-metadata">Instance Metadata</a></li>
               </ul>
           </div>
       </div>
   </body>
...
HTML
   ...
   cat > /var/www/html/instance-metadata << 'SCRIPT'
   #!/bin/bash
...
SCRIPT
   ...
   chmod +x /var/www/html/instance-metadata
...
EOF
    ...
    echo ""
    print_header "Lab 2 Setup Complete"
    ...
    echo -e "${BLUE}Focus: AMI Creation & Instance Lifecycle${NC}"
    echo ""
    echo -e "${YELLOW}Key Topics:${NC}"
    echo "• Advanced instance lifecycle management"
    echo "• Custom AMI creation and versioning"
    echo "• Performance comparison: AMI vs User Data"
